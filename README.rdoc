...
that already exists under your application root directory (e.g., application-root-
directory/spec/assignment_spec.rb). This assignment_spec.rb file contains tests that will help determine
...
the detailed tests will be focused on the User and TodoList only. You will use the remaining classes more in a follow-
on assignment.
